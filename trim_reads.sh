...
output1_paired=trimmed_reads/sars_spike_protein_raw_reads_1_trimmed_paired.fastq.gz
output1_unpaired=trimmed_reads/sars_spike_protein_raw_reads_1_trimmed_unpaired.fastq.gz

output2_paired=trimmed_reads/sars_spike_protein_raw_reads_2_trimmed_paired.fastq.gz
output2_unpaired=trimmed_reads/sars_spike_protein_raw_reads_2_trimmed_unpaired.fastq.gz
